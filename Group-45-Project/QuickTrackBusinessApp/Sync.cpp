...
void Sync::exportSignInOut(vector<tempUser> customers){
		...
		remote.pstmt = remote.con->prepareStatement("INSERT INTO tbl_SignInOut(SIO_timeIn, SIO_timeOut, SIO_userID, SIO_firstname, SIO_lastName, SIO_email, SIO_phoneNumber) VALUES ('"+customer.timeIn+"','"+customer.timeOut+"','"+customer.userID+"','"+customer.firstName+"','"+customer.lastName+"','"+customer.email+"','"+customer.phoneNumber+"')");

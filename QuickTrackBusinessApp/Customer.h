...
class Customer{
	...
	public:
        ...
        */
        Customer(string user, string first, string last,string pass, string emailAddr, long long int phoneNumber);
        ...
        *
        * @param phoneNumber long long int - the customer's phone number
        */
        ...
        */
        void setPhoneNum(long long int phoneNumber);
